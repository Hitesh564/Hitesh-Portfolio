...
export function Contact() {
  ...
  const links = [
    {
      label: "Resume",
      value: "Hitesh_Jindal_Resume.pdf",
      href: resumeUrl,
    ...
    {
      label: "Email",
      value: "jindalhitesh564@gmail.com",
      href: "mailto:jindalhitesh564@gmail.com",
      icon: <Mail size={14} />,
    },
    {
      label: "GitHub",
      value: "github.com/Hitesh564",
      href: "https://github.com/Hitesh564",
      icon: <Github size={14} />,
    },
    {
      label: "LinkedIn",
      value: "linkedin.com/in/hitesh-jindal56",
      href: "https://www.linkedin.com/in/hitesh-jindal56/",
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Designed and built by Hitesh Jindal • Deployed on Vercel{" "}
              </span>
            </div>
          </div>
        </div>
