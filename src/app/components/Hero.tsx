...
// @ts-ignore
import resumeUrl from "../../assets/Hitesh_Jindal_Resume.pdf?url";

import { RobotHero } from "./RobotHero";
import { HITESH_DATA } from "../../data/hiteshData";

const PROFILE_IMAGE = "/hitesh_avatar.png";
const CONTACT_EMAIL = HITESH_DATA.personal.email;
      ...
      >
        ...
        <div ref={layerText} style={{ willChange: "transform" }}>
          ...
          <div style={{ overflow: "visible", marginBottom: "-0.05em" }}>
            ...
            >
              {HITESH_DATA.personal.firstName}
            </m.h1>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
              {[
                {
                  href: `mailto:${HITESH_DATA.personal.email}`,
                  icon: <Mail size={15} />,
                  label: "Email",
                },
                {
                  href: HITESH_DATA.personal.githubUrl,
                  icon: <Github size={15} />,
                  label: "GitHub",
                },
                {
                  href: HITESH_DATA.personal.linkedinUrl,
              ...
              {!isMobile && (
                <m.a
                  href={resumeUrl}
                  download="Hitesh_Jindal_Resume.pdf"
            ...
            >
              ...
              >
                {HITESH_DATA.personal.statusPill}
              </span>
            </div>
          </m.div>
        </div>

        {/* RIGHT - Interactive 3D Spline Robot Layer */}
        {isMobile ? (
          <m.div
