...
const recs = [
  {
    ...
    date: "Nov 2024",
    text: "Hitesh showed a great flexibility and stretched to complete a challenging task which resulted in client's delight. He was able to code a logic which client's other partner could not do it. Well done Hitesh.",
  },
  {
  ...
  },
  {
    ...
    relationship: "Client • HSBC",
    date: "Feb 2025",
    text: "He would keep an open mind, welcome challenges, and think to deliver an end-to-end solution. I rate Hitesh highly - not just for his knowledge and skills, but his attitude to continue trying under pressure and deliver. I'm sure he will be adding great value wherever he works.",
  },
  {
    name: "Tulsi Patro",
    title: "AI Engineer",
    ...
    date: "Nov 2023",
    text: "Hitesh is a risk-taker, never shying away from trying innovative approaches - and what sets him apart is his ability to convert those risks into successful implementations. His commitment to meeting deadlines while upholding the quality of work is a testament to his professionalism. Fearlessness in taking on challenges inspires the entire team to push boundaries and strive for excellence.",
  },
];
